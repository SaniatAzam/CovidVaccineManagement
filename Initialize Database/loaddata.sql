...
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('5781164871', 'Leandra Parrett', 'Male','2004-04-06', '2020-07-02', '5527401126', 'Sar Chakān', '01733 Manley Pass', null, 'Health Care Workers');
...
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('9218526901', 'Jackelyn Guidi', 'Male','1984-05-31', '2020-10-24', '5683252174', 'Al Ḩashwah', '3040 Mallory Circle', null, 'Essential Service Workers');
...
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('7518538210', 'Addie Drane', 'Female','1975-11-16', '2020-04-01', '8652634458', 'Raša', '76 Chive Drive', '52223', 'Everybody Else');
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('5153164721', 'Sonja Darter', 'Female','2007-04-26', '2020-07-07', '1989486940', 'San Jerónimo', '2951 Moose Road', '15007', 'Everybody Else');
...
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('1319542247', 'Zacharie Dimitriou', 'Female','2005-03-11', '2020-12-15', '9997594658', 'Kynopiástes', '1 Eggendart Trail', null, 'Teachers');
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('1293084093', 'Darsey Stoppard', 'Male','1991-04-23', '2020-10-27', '5455686721', 'Póvoa de Penela', '16001 Surrey Way', '3630-354', 'Teachers');
...
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('9605607387', 'Jolie Mayling', 'Female','1981-05-28', '2021-01-10', '1706892341', 'Vällingby', '2214 Hazelcrest Street', '162 50', 'Health Care Workers');
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('2620927072', 'Tome Montrose', 'Female','1997-03-25', '2020-06-01', '2394063672', 'Elías', '90 Armistice Plaza', '417018', 'PhysProx to 2nd');
...
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('1556610351', 'Gonzalo Peatman', 'Female','1989-06-17', '2020-08-14', '9971273732', 'Érd', '946 Declaration Crossing', '2035', 'Essential Service Workers');
...
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('9765781326', 'Claudina Philippe', 'Male','1997-11-24', '2021-01-10', '6684448345', 'Skogås', '4 Debs Crossing', '142 50', 'Immunologically Compromised');
...
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('4180233959', 'Charlotte Iwanowski', 'Female','1995-07-03', '2020-06-08', '1254014964', 'Badāmā', '688 Delladonna Hill', null, 'Everybody Else');
...
insert into Person (hinsurnum, name, gender, dob, regisdate, phone, city, streetadd, postalcode, cname) values ('1669325989', 'Maddie Foxworthy', 'Male','1973-01-02', '2020-12-04', '8378422490', 'Rio Covo ( Santa Eulália )', '15 Maywood Alley', '4755-484', 'Health Care Workers');
...
insert into VaccLocations (lname, lcity, lstreetadd, lpostalcode) values ('Y-Solwowarm', 'Maisí', 'Mockingbird', null);
...
insert into VaccLocations (lname, lcity, lstreetadd, lpostalcode) values ('Viva', 'Paradyż', 'Summerview', '26-333');
...
insert into VaccLocations (lname, lcity, lstreetadd, lpostalcode) values ('Overholder', 'Imġarr', 'Pine View', 'ZBG');
insert into VaccLocations (lname, lcity, lstreetadd, lpostalcode) values ('Opela', 'Kulotino', 'Scott', '174335');
insert into VaccLocations (lname, lcity, lstreetadd, lpostalcode) values ('Zoolabs', 'Černovice', '7th', '618 00');
...
insert into VaccLocations (lname, lcity, lstreetadd, lpostalcode) values ('Flowdesks', 'Traganón', 'Toban', null);
...
insert into VaccLocations (lname, lcity, lstreetadd, lpostalcode) values ('Opelana', 'Kavýli', 'Paget', null);
insert into VaccLocations (lname, lcity, lstreetadd, lpostalcode) values ('Konklab', 'Newport Beach', 'Bluestem', '92662');
insert into VaccLocations (lname, lcity, lstreetadd, lpostalcode) values ('Cardguard', 'Velké Bílovice', 'Porter', '691 02');
